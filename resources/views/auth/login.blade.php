...
<head>
    ...
    <title>Login Booking Tours</title>
            ...
            <div class="col-sm-12">
                <div class="main-menu">
                    <div class="menu-left">
                        ...
                        <a href="/"><img src="{{asset ('assets-landingpage/images/booking.jpg') }}" alt=""
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="theme-card">
                    <form class="theme-form" method="POST" action="{{route('client.login.submit')}}">
                        @csrf
            ...
            <div class="col-lg-6 right-login">
                ...
                <div class="theme-card authentication-right">
                    <h6 class="title-font">Daftar dan Booking</h6>
                    <p>Daftarkan segera untuk membuat perjalanan Anda Menjadi lebih Mudah dan Santai</p>
                    <a href="{{ route('client.register') }}" class="btn btn-solid">Daftar</a>
                </div>
            </div>
        </div>
    </div>
