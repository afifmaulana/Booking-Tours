...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Sep 2020 09:55:51 GMT -->
<head>
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Welcome to Admin Booking Tours</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="POST" action="{{ route('admin.login.submit') }}">
                                        @csrf
                                        <div class="form-group">
                                            <input required="" name="username" type="text" class="form-control {{ $errors->has('username') ? ' is-invalid' : '' }}"
                                            placeholder="Username" id="exampleInputEmail1" value="{{ old('username') }}">
                                        ...
                                        <div class="form-group">
                                            <input required="" name="password" type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}"
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Sep 2020 09:55:53 GMT -->
</html>
